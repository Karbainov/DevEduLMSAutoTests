...
| Gabriel   | Wilson   | string     | wl@gmail.com     | Gabi     | 11345678 | SaintPetersburg | 15.04.1999 | string        | 89514781247 |
| Isabella  | Abramson | string     | isi@gmail.com    | Bella    | 11345578 | SaintPetersburg | 22.05.2001 | string        | 89514551247 |
| Sophie    | Anderson | string     | sophie@gmail.com | Sophi    | 11344678 | SaintPetersburg | 18.01.1998 | string        | 89511781247 |
And register new teachers in service
| FirstName | LastName   | Patronymic | Email           | Username | Password | City            | BirthDate  | GitHubAccount | PhoneNumber |
| Maksim    | Karbainov  | string     | maks@gmail.com  | Maksim   | 22345678 | SaintPetersburg | 18.05.1995 | string        | 89521496531 |
| Anton     | Efremenkov | string     | anton@gmail.com | Anton    | 22345698 | SaintPetersburg | 22.08.1988 | string        | 89521477531 |
And register new tutors in service
| FirstName | LastName   | Patronymic | Email           | Username | Password | City            | BirthDate  | GitHubAccount | PhoneNumber |
| Elisey    | Kakoyto   | string     | elisey@gmail.com | Elisey   | 13345678 | SaintPetersburg | 07.10.1996 | string        | 89518963148 |
